...
export const projects: Project[] = [
    ...
    id: "p5",
        ...
        section: "archive",
        description:
            "The Code Cup is a native Android coffee-ordering application built with Kotlin and Jetpack Compose. The app delivers a complete offline customer journey — browsing a 12-drink menu, searching and filtering products, customizing drink size, ice, and espresso shots, managing favorites, adding items to a persistent cart, checking out, and tracking ongoing or completed orders. It also includes loyalty stamps, reward-point accumulation, reward redemption, editable user profiles, order receipts, and one-tap reordering from purchase history. The application follows a pragmatic Clean MVVM architecture with Room, Repository Pattern, Coroutines, StateFlow, Material 3, and lifecycle-aware state management. All customer data, orders, rewards, and preferences are stored locally, while transactional operations ensure that checkout, reward allocation, and redemption remain consistent and safe.",
        tags: [ "Kotlin", "Jetpack Compose", "Android", "Room", "MVVM", "Material 3" ],
        demo: "https://www.youtube.com/watch?v=cdRv2seNAU8",
        github: "github.com/vquclinh/TheCupCoffee",
        image: codeCupImg,
    },
    {
        id: "p8",
